# Solutions for Trading of Russian Stocks
...
Fig. 1. Line Plot of Stock Prices with Moving Averages via quantmod library

![](https://github.com/vladislavpyatnitskiy/rustrading/blob/main/Plots/MA%20plot.png?raw=true)
Fig. 2. Another Line Plot of Stock Prices with Moving Averages

![](https://github.com/vladislavpyatnitskiy/rustrading/blob/main/Plots/Relative%20Strength%20Index%20Plot.png?raw=true)
Fig. 3. Relative Strength Index
```
  Ticker      RSI Signal
